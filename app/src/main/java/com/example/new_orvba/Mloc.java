...
public class Mloc extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("location_requests");
    ...
    private void submitRequest() {
        ...
        databaseReference.push().setValue(mechanicLocationData);

        // Display a success message
        Toast.makeText(Mloc.this, "Registration Complete", Toast.LENGTH_SHORT).show();
